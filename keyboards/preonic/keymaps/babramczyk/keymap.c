 ...
 * | Shift|   Z  |   X  |   C  |   V  |   B  |   N  |   M  |   ,  |   .  |   /  | ' (?)|
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Ctrl | Opt |CmdOpt|CmdShft| Cmd  |Raise |Space |  Cmd  | Down |  Up  | Left |Right |
 * `-----------------------------------------------------------------------------------'
 */
[_QWERTY] = LAYOUT_preonic_grid(
  ...
  KC_LCTL, KC_LALT, LCMD(KC_LALT), LCMD(KC_LSFT), KC_LGUI, RAISE,   KC_SPC,  KC_LGUI, KC_DOWN, KC_UP,   KC_LEFT, KC_RGHT
),
